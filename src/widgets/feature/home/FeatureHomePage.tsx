...
const attractions = [
  { name: "Карусель",          price: "50 000 сум", rating: 4.9, img: "/images/ride-carousel.png" },
  { name: "Колесо обозрения",  price: "70 000 сум", rating: 4.7, img: "/images/ride-ferris.png" },
  { name: "Карусель",          price: "50 000 сум", rating: 4.9, img: "/images/ride-carousel.png" },
];
...
const FeatureHomePage = () => {
  ...
  return (
    <div className="relative -mx-2" style={{ backgroundColor: "var(--screen-bg)" }}>
      ...
      >
        ...
        >
          ...
          <div style={{ lineHeight: 1 }}>
            <div style={{ fontFamily: "Nunito,sans-serif", fontWeight: 600, fontSize: 12, color: "#222" }}>32°</div>
            <div style={{ fontFamily: "Nunito,sans-serif", fontSize: 9, color: "#444" }}>Солнечно</div>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <span
              ...
              style={{ top: 6, right: 7, width: 6, height: 6, background: "#F60000" }}
            />
          </button>
        </div>
      </div>
      ...
      >
        ...
        >
          <div>
            <div style={{ fontFamily: "Nunito,sans-serif", fontSize: 13, color: "rgba(255,255,255,0.85)", marginBottom: 4 }}>
              Ваш баланс
            </div>
            <div style={{ fontFamily: "'Baloo 2',sans-serif", fontWeight: 700, fontSize: 28, color: "#fff", lineHeight: 1 }}>
              70 000 сум
            </div>
            <div style={{ fontFamily: "Nunito,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.8)", marginTop: 6 }}>
              1 200 паркоинов
            </div>
          </div>
          <button
        ...
        <div
          ...
          style={{ height: 170, background: "linear-gradient(270deg,#E3F9FF,#75E9F0)" }}
        >
          <div className="absolute" style={{ left: 16, top: 16, width: 210 }}>
            <div style={{ fontFamily: "'Baloo 2',sans-serif", fontWeight: 700, fontSize: 18, lineHeight: "23px", color: "#1b3a40" }}>
              Начинается Летний Фестиваль
            </div>
            <div style={{ fontFamily: "Nunito,sans-serif", fontSize: 13, color: "#1b5f6f", marginTop: 4 }}>
              с 15 июля по 31 августа
            </div>
            <button
              className="flex items-center"
              style={{
                marginTop: 18, height: 28, padding: "0 16px",
                border: "none", borderRadius: 35,
                background: "#1292A7", color: "#fff",
          ...
          <img
            ...
            style={{
              right: -22, bottom: -6, height: 182, width: "auto",
        ...
        <div className="flex justify-between" style={{ padding: "2px 4px" }}>
          {categories.map((cat) => (
            <button key={cat.label} className="flex flex-col items-center gap-[7px]" style={{ width: 74 }}>
              <img
                src={cat.img}
                alt={cat.label}
                style={{
              ...
              />
              <span style={{ fontFamily: "Nunito,sans-serif", fontSize: 11.5, color: "var(--text)" }}>
                {cat.label}
              </span>
            </button>
          ))}
        ...
        <div>
          <div className="flex justify-between items-center" style={{ marginTop: 2 }}>
            <span style={{ fontFamily: "'Baloo 2',sans-serif", fontWeight: 700, fontSize: 18, color: "var(--text)" }}>
              Аттракционы
            </span>
            <span className="flex items-center gap-1 cursor-pointer" style={{ fontFamily: "'Baloo 2',sans-serif", fontWeight: 500, fontSize: 15, color: "var(--text)" }}>
            ...
            {attractions.map((item, i) => (
              ...
              >
                ...
                <div className="relative" style={{ height: 104 }}>
                  ...
                  <span
                    ...
                    style={{
                      ...
                      borderRadius: 20,
                      background: "rgba(255,255,255,0.92)",
                      fontFamily: "Nunito,sans-serif", fontWeight: 700, fontSize: 11, color: "#222",
                    }}
                  >
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="#FFB000">
                ...
                <div style={{ padding: "9px 11px 12px" }}>
                  ...
                  <div style={{ fontFamily: "Nunito,sans-serif", fontWeight: 700, fontSize: 12.5, color: "var(--text2)", marginTop: 2 }}>
                    {item.price}
                  </div>
                </div>
              </div>
        ...
        <div
          className="relative overflow-hidden rounded-[22px]"
          style={{ height: 158, background: "linear-gradient(270deg,#ECFDF3,#6CE9AB)" }}
        >
          <div className="absolute" style={{ left: 16, top: 18, width: 200 }}>
            <div style={{ fontFamily: "'Baloo 2',sans-serif", fontWeight: 700, fontSize: 22, color: "#143b29" }}>
              Акция дня
            </div>
            <div style={{ fontFamily: "Nunito,sans-serif", fontSize: 13.5, lineHeight: "18px", color: "#2c6b4f", marginTop: 4 }}>
          ...
          <img
            ...
            className="absolute pointer-events-none"
            style={{
              right: -30, bottom: -14, height: 172, width: "auto",
              filter: "drop-shadow(0 6px 10px rgba(0,0,0,0.12))",
            }}
          />
        </div>
